...
class SetFlagOnDestruct {
 public:
  SetFlagOnDestruct(std::atomic<bool>* flag) : flag_(flag) {}
  ~SetFlagOnDestruct() { std::atomic_store(flag_, true); }
