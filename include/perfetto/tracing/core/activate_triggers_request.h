...
#ifndef INCLUDE_PERFETTO_TRACING_CORE_ACTIVATE_TRIGGERS_REQUEST_H_
#define INCLUDE_PERFETTO_TRACING_CORE_ACTIVATE_TRIGGERS_REQUEST_H_
...
class PERFETTO_EXPORT ActivateTriggersRequest {
 public:
  ...
  bool operator!=(const ActivateTriggersRequest& other) const {
    return !(*this == other);
  }

  // Conversion methods from/to the corresponding protobuf types.
  void FromProto(const perfetto::protos::ActivateTriggersRequest&);
  void ToProto(perfetto::protos::ActivateTriggersRequest*) const;

  int trigger_names_size() const {
    return static_cast<int>(trigger_names_.size());
  }
  const std::vector<std::string>& trigger_names() const {
...
#endif  // INCLUDE_PERFETTO_TRACING_CORE_ACTIVATE_TRIGGERS_REQUEST_H_
