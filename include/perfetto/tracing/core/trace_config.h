...
class TraceConfig_DefaultDataSource;
...
class PERFETTO_EXPORT TraceConfig {
 public:
  ...
  class PERFETTO_EXPORT DefaultDataSource {
   public:
    DefaultDataSource();
    ~DefaultDataSource();
    DefaultDataSource(DefaultDataSource&&) noexcept;
    DefaultDataSource& operator=(DefaultDataSource&&);
    DefaultDataSource(const DefaultDataSource&);
    DefaultDataSource& operator=(const DefaultDataSource&);
    bool operator==(const DefaultDataSource&) const;
    bool operator!=(const DefaultDataSource& other) const {
      return !(*this == other);
    }

    // Conversion methods from/to the corresponding protobuf types.
    void FromProto(const perfetto::protos::TraceConfig_DefaultDataSource&);
    void ToProto(perfetto::protos::TraceConfig_DefaultDataSource*) const;
    ...
    bool disable_trace_stats() const { return disable_trace_stats_; }
    void set_disable_trace_stats(bool value) { disable_trace_stats_ = value; }
  ...
  const DefaultDataSource& default_data_source() const {
    return default_data_source_;
  }
  DefaultDataSource* mutable_default_data_source() {
    return &default_data_source_;
  }
 ...
 private:
  ...
  DefaultDataSource default_data_source_ = {};
